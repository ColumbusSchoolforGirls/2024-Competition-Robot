...
public static AutoStep[] autoLeftMain = {
  ...
  new AutoStep(AutoAction.DRIVE, -87),
  new AutoStep(AutoAction.TURN, 121),
...
public static AutoStep[] autoMiddleMain = {
  ...
  new AutoStep(AutoAction.DRIVE, 53), //changed match 22 from 80 to 75
  new AutoStep(AutoAction.SHOOT, 0)
};

  public static AutoStep[] autoMiddleDrive = { // figure out later
  new AutoStep(AutoAction.DRIVE, -65), //-65
};
