...
public final class Constants {
    ...
    public static final int INTAKING_RPM = 3000;
    public static final int REVERSE_INTAKING_RPM = -2100;

    public static final int INTAKE_RPM = 3700;
    public static final int SHOOTER_RPM = -3700;
    public static final int SHOOTING_THRESHOLD = 3500;

    public static final int AMP_INTAKE_RPM = 1825;
    public static final int AMP_INTAKE_THRESHOLD = 1675;
    public static final int AMP_SHOOTER_RPM = -2070;
    public static final int AMP_SHOOTING_THRESHOLD = 1920;

    public static final int SIDE_SHOOTER_RPM = -3350;
    public static final int SIDE_INTAKE_RPM = 3350;
